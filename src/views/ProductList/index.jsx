...
const ProductCard = ({product, count, image, name, brand, price, handleClick, handleAddToCart }) => (
    <Card className="content-card" onClick={handleClick} style={{border:"1px solid #f7f7f7",filter: "drop-shadow(5px 5px 5px #f7f7f7)"}}>
        <div className="overlay-card-wrapper">
            <div className="content-media" style={{ height: isMobile && "250px",padding:"15px" }}>
        ...
        <CardContent>
            <Typography  sx={{fontSize:{xs:"1.1rem",sm:"",md:"",lg:""},  minHeight: isMobile &&"3.5rem",maxHeight:isMobile&&"3.5rem"}}>
            {_.truncate(_.trim(brand), { length: 23 })}
            </Typography>
            <Typography variant="subtitle2"  color="text.secondary" >
            {_.truncate(_.trim(name), { length: 19})}
            </Typography>
                                ...
                                <>
                                    {isMobile ? <Grid item xl={3} lg={4} md={6} sm={6} xs={6}>
                                        <ProductCard
                                            ...
                                            name={_.truncate(_.trim(product.name, { length: 20 }))}
                                            price={product.price}
                                            mrp={product.price}
